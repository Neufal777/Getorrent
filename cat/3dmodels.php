...
<!-- HEADER FINAL -->
	<br>
	<div id="top"><a id="topic"><h2>/3D Models/</h2></a></div>
<?php

include '../php/connection.php';

	$check_results = mysqli_query($db_con,"SELECT * FROM uploads WHERE topic = '3dModels' order by 1 desc ");
