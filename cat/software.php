...
<!-- HEADER FINAL -->
	<br>
	<div id="top"><a id="topic"><h2>/Software/</h2></a></div>
<?php

include '../php/connection.php';

	$check_results = mysqli_query($db_con,"SELECT * FROM uploads WHERE topic = 'Software' order by 1 desc ");
