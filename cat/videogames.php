...
<!-- HEADER FINAL -->
	<br>
	<div id="top"><a id="topic"><h2>/Videogames/</h2></a></div>
<?php

include '../php/connection.php';

	$check_results = mysqli_query($db_con,"SELECT * FROM uploads WHERE topic = 'Videogames' order by 1 desc ");
